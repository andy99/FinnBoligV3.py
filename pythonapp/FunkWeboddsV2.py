...
# Dette programmet er for kjoring av ett utrekk dato og bane maa angies
print(Lastedato,'Lastedato har verdien')
s = requests.get("http://www.travsport.no/Sport/Resultater/Bergen-travpark/?date=" + Lastedato)
s.content
