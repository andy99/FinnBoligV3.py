...
coding='utf8'
if os.path.isfile("D:\workplace_python\PythonDatavarehus\Dntresultatdatoer.txt"):
    print("D:\workplace_python\PythonDatavarehus\Dntresultatdatoer.txt","blir slettet")
    os.remove("D:\workplace_python\PythonDatavarehus\Dntresultatdatoer.txt")
Bane='Forus-Travbane'
print(Bane,'= bane')
num = 415
while num < 416:
...
#    print(Hesttabell[1],"hestetabell")
    ...
    wkol = 0
    with open('D:\workplace_python\PythonDatavarehus\Dntresultatdatoer.txt', 'a') as f:
