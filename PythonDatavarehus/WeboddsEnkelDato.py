...
#     print(elements,"Innhold elements")
    ...
    with open('D:\workplace_python\PythonDatavarehus\DNTodds.txt', 'a') as g:
        y=0   #vinner odds
        z = 1 #Plass odds
        a = 2 #Tvilling odds
        b = 3 #trippel odds
