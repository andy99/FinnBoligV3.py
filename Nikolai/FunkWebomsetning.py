...
#     r = requests.get("http://www.travsport.no/Sport/Resultater/Leangen-Travbane/?date=" + Lastedato"
    r = requests.get("http://www.travsport.no/Sport/Resultater/Leangen-Travbane/?date=20200309")
    r.content
...
#             utvinnerodds = 0
                    if vodds == 0:
                        ...
                        print(voddlen,"Vinner omsetning")
                        print(vinnerodds,"Vinner omsetning innhold")
